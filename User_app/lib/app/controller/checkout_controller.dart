...
//payment
  int initialpaymentId = 1;
  int paymentId = 0;
  String payMethodName = '';
  int onlinePaymentId = 0;
  String onlinepayMethodName = '';
  bool onlinePaymentisTrue = false;
  bool cardPaymentisTrue = false;
  bool upiPaymentisTrue = false;
  int upiPaymentId = 0;
  String upipayMethodName = '';
...
//payment new added
  void selectOnlinePaymentMethod(int id) {
    onlinePaymentId = id;
    if (onlinePaymentId == 1) {
      onlinepayMethodName = 'Card';
    } else if (onlinePaymentId == 2) {
      onlinepayMethodName = 'UPI';
    }
    update();
  }

  void selectUpiPaymentMethod(int id) {
    upiPaymentId = id;
    if (upiPaymentId == 1) {
      upipayMethodName = 'Google Pay';
    } else if (upiPaymentId == 2) {
      upipayMethodName = 'Phone Pay';
    } else if (upiPaymentId == 3) {
      upipayMethodName = 'Paytm';
    }
    update();
  }

  void selectOnlinePayment(bool value) {
    onlinePaymentisTrue = value;
    update();
  }

  void selectCardPayment(bool value) {
    cardPaymentisTrue = value;
    update();
  }

  void selectUpiPayment(bool value) {
    upiPaymentisTrue = value;
    update();
  }
}
