...
export class CategoriesComponent implements OnInit {
  ...
  getList() {
    ...
    this.stores = [];
    this.api
      .post_private('v1/categories/getList', {
  ...
  async onChange(item: any, index: any) {
    ...
    Swal.fire({
      ...
      text: this.util.translate(
        'After confirming it, this category will disappear from your outlet. later you can activate it by adding it again.'
      ),
      icon: 'warning',
  ...
  async removeMaster() {
    Swal.fire({
      ...
      text: this.util.translate(
        'After confirming it, this category and food items associated with this category will be completely deleted from your outlet'
      ),
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
  ...
  saveId(ids: any) {
    ...
    this.util.show();
    this.api
      .post_private('v1/categories/updateCategories', param)
      .then(
        (data: any) => {
          this.util.hide();
          console.log(data);
  ...
  updateCategory() {
    ...
    this.util.show();
    this.api
      .post_private('v1/storeCates/updateInfo', param)
      .then(
        (data: any) => {
          this.util.hide();
          this.myModal2.hide();
  ...
  createCategory() {
    ...
    this.util.show();
    this.api
      .post_private('v1/storeCates/create', param)
      .then(
        (data: any) => {
          this.util.hide();
          this.myModal2.hide();
  ...
  async updateStoreCategories(item: any) {
    ...
    this.util.show();
    this.api
      .post_private('v1/storeCates/getById', { id: item })
      .then(
        (data: any) => {
          console.log(data);
          this.util.hide();
  ...
  async onStoreCateChange(item: any) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.util.show();
        this.api
          .post_private('v1/storeCates/updateStatus', param)
          .then(
            (data: any) => {
              this.util.hide();
              console.log(data);
