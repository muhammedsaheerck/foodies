...
export class FoodsComponent implements OnInit {
  ...
  getFoodList() {
    ...
    this.dummy = Array(10);
    this.api
      .post_private('v1/storeWeb/getFoodList', {
  ...
  updateStatus(item: any) {
    ...
    this.api
      .post_private('v1/foods/updateStatus', item)
      .then(
        (data: any) => {
          console.log(data);
        },
  ...
  updateInfo(itemId: any) {
    ...
    this.util.show();
    this.api
      .post_private('v1/foods/getProductInfo', param)
      .then(
        (data: any) => {
          console.log(data);
          this.util.hide();
  ...
  updateStock(item: any) {
    ...
    this.api
      .post_private('v1/foods/updateStock', item)
      .then(
        (data: any) => {
          console.log(data);
        },
  ...
  updateTag(item: any) {
    ...
    this.api
      .post_private('v1/foods/updateRecommended', item)
      .then(
        (data: any) => {
          console.log(data);
        },
  ...
  onVariationsSave() {
    ...
    if (this.what == 'sub' && this.subNewItem == false) {
      ...
      this.variations[this.mainVariationIndex].items[
  ...
  saveProduct() {
    ...
    this.util.show();
    this.api
      .post_private('v1/foods/save', param)
      .then(
        (data: any) => {
          console.log(data);
          this.util.hide();
  ...
  updateProduct() {
    ...
    this.util.show();
    this.api
      .post_private('v1/foods/update', param)
      .then(
        (data: any) => {
          console.log(data);
          this.util.hide();
