...
import 'package:foodies_vendors/app/backend/models/drivers_model.dart';
import 'package:foodies_vendors/app/backend/models/orders_model.dart';
import 'package:foodies_vendors/app/backend/models/user_info_model.dart';
import 'package:foodies_vendors/app/backend/parse/order_details_parse.dart';
import 'package:foodies_vendors/app/controller/driver_list_controller.dart';
...
import 'package:foodies_vendors/app/util/toast.dart';
...
class OrderDetailsController extends GetxController implements GetxService {
  ...
  Future<void> getOrderDetail() async {
    ...
    if (response.statusCode == 200) {
      ...
      log("driverinfo :" + driverInfo.toString());
      ...
      _userInfo = storeData;
      log("orderTo " + orderInfo.orderTo.toString());
